        ...
        Host : {
            ...
            endGame : function(data) {
                ...
                if(winner1==p2Name)
                {
                    if(winner2==p4Name)
                    {
                        winner = (p2Score<p4Score)?p4Name:p2Name ;
                    }
                    else
                    {
                        winner = (p2Score<p3Score)?p3Name:p2Name ;
                    }
                }
                else
                {
                    if(winner2==p4Name)
                    {
                        winner = (p1Score<p4Score)?p4Name:p1Name ;
                    }
                    else
                    {
        ...
        Player : {
            ...
            newWord : function(data) {
                ...
                $.each(data.list, function(){
                    $list.append($('<li/>').append($('<button/>').addClass('btnAnswer').addClass('btn').val(this).html(this)))
                });
                $('#gameArea').html($list);
            },
            endGame : function() {
                $('#gameArea').html('<div class="gameOver">Game Over!</div>').append($('<button>Start Again</button>').attr('id','btnPlayerRestart').addClass('btn').addClass('btnGameOver'));
            }
        },
